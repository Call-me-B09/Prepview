  ...
  return (
    <div className="relative w-full min-h-screen text-white overflow-y-auto">
      ...
      <div className="fixed top-4 right-6 z-50">
        <button className="px-6 py-2 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 text-white font-semibold shadow-lg hover:bg-white/20 transition">
          Get Started
        </button>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 space-y-32 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="space-y-24">
          ...
          <section className="pb-32">
            ...
            <button className="mt-6 px-8 py-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 text-white font-semibold shadow-lg hover:bg-white/20 transition">
              Get Started
            </button>
          </section>
        </div>
